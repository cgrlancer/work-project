...
activitiModeler.factory('sessionInjector', ['$cookies',function ($cookies){
    return {
...
activitiModeler
  ...
  .run(['$rootScope', '$timeout', '$modal', '$translate', '$location', '$window', '$http', '$q','$cookies',
        function($rootScope, $timeout, $modal, $translate, $location, $window, $http, $q,$cookies) {
